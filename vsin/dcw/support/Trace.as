package vsin.dcw.support
{
    ...
    public class Trace extends Object
    {
        ...
        public static function buildGetLogMenu(param1:Sprite, param2:String) : void
        {
            var _loc_3:* = new ContextMenuItem(param2 + " log", true);
            _loc_3.addEventListener(ContextMenuEvent.MENU_ITEM_SELECT, onLogSelect);
            if (!param1.contextMenu)
            {
                param1.contextMenu = new ContextMenu();
            }
            var _loc_4:* = param1.contextMenu;
            param1.contextMenu.hideBuiltInItems();
            _loc_4.customItems.push(_loc_3);
            param1.contextMenu = _loc_4;
            return;
        }// end function
